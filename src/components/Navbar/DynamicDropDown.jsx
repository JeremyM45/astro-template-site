  ...
  return (
    <div onMouseLeave={() => setIsVisible(false)}>
      <div className="relative group" >
        ...
        <button className="flex flex-row border-b border-transparent items-center w-full pl-2 py-4 mt-2 text-base text-left bg-transparent md:w-auto md:inline md:mt-0 lg:pl-4 focus:outline-none hover:border-highlightRed hover:text-highlightRed">
                  ...
                  cardData.map(function(data, i) {
                    ...
                    return (
                      <div key={i} onMouseOver={() => handleDynamicMenu(componentData)}>
                        <li>
                          <div >
                            <a  href="/"  className="flex flex-row mr-6 p-2 border-b border-transparent hover:border-highlightRed hover:text-highlightRed">
